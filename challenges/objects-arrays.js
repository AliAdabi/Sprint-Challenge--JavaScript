...
let universities = [];
universities = graduates.map(item =>{
...
let contactInfo = [];
contactInfo = graduates.map(item =>{
...
*/
let displayNames = [];
displayNames = zooAnimals.map(item =>{
  return `name: ${item.animal_name}, scientific name: ${item.scientific_name}`
})
